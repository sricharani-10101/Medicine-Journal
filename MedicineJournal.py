...
elif symptom == "headache" or "Headache":
...
elif symptom == "sore throat" or "Sore throat":
...
elif symptom == "stomach ache" or "Stomach ache":
...
elif symptom == "motion sickness" or "Motion sickness":
...
elif symptom == "diarrhoea" or "Diarrhoea":
